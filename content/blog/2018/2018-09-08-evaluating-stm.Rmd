...
After we have the text downloaded, let's clean the text and make a data frame containing only the text, timestamp, plus an ID to identify each "document", i.e., post.
